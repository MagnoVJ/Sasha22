...
namespace sasha22 {
    ...
    void NavigatingCameraSceneDemo::processInput(GLFWwindow* window, float deltaTime, glm::vec3& cameraPos, glm::vec3& cameraFront, glm::vec3& cameraUp) {
    ...
    void NavigatingCameraSceneDemo::update_draw(glm::vec3 cameraPos, glm::vec3 cameraFront, glm::vec3 cameraUp, float fov) {
